...
import { apiAmazonFBAGetOrderSheetUpload,apiAmazonFBAGetOrderSheet} from '../../../redux/apis/DataAction';
const { TabPane } = Tabs;
...
const AmazonFBAOrders = (props) => {
    ...
    const insertAmazonFBAOrderSheet = () => {
        ...
        dispatch(apiAmazonFBAGetOrderSheetUpload(formData)).then(data => {
                ...
                <Cards title="Get Sears Orders (API)" caption="The simplest use of Drawer" >
                    ...
                    <Col lg={8} xs={24}>
                                ...
                                <div className="atbd-drawer" style={{ marginLeft: 0 }}>
                                    ...
                                    <Button size="large" type="success" style={{ backgroundColor: '#42ba96', color: 'white', marginRight: 8, }} onClick={insertAmazonFBAOrderSheet}> Insert Sheet</Button>
                                    <br></br>
...
export default AmazonFBAOrders;

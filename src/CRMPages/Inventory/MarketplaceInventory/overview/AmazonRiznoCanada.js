...
const AmazonPU = (props) => {
  ...
  //  // console.log('vendornameState',vendornameState)
    const amazonPUcolumn = ['AmazonRiznoCanada_Price', 'AmazonRiznoCanada_Deliveryinfo', 'AmazonRiznoCanada_Status']

    const columnDropdown = ['ADD AMAZON INVENTORY', 'ALL', 'OTHER']

    const AmazonRiznoCanada = "AmazonRiznoCanada"
                ...
                <Row >
                    ...
                    <Col span={24} >
                                ...
                                <FilterReport genrateFilter={genrateFilter} vendornameState={vendornameState} brandnameState={brandnameState} categorynameState={categorynameState} collectionState={collectionState}
                                    puStatusState={puStatusState} Type={Type} title={'Amazon Rizno Canada'}/>
                    ...
                    <Col span={24} style={{ marginTop:20 }}>
                        ...
                        <Column genrateFeed={(col, val) => { genrateFeed(AmazonRiznoCanada, col, isSeller, val) }} additionalColumns={amazonPUcolumn} columnDropdown={columnDropdown} />
                    </Col>

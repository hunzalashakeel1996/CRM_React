...
useEffect(() => {    
  ...
  if ('MPALL' === subOrderType&&activeTab === 'ItemPNL') {
  ...
  else if (activeTab === 'ItemPNL'&&['Amazon', 'AmazonRizno', 'Walmart', 'Sears', 'Ebay'].includes(subOrderType)) {
  ...
  else if (activeTab === 'ItemPNL'&&['JLC', 'PU'].includes(subOrderType)) {

            ...
            <Cards title={title} style={{ marginLeft: 10 }}>
                ...
                <Row gutter={15} style={{marginBottom: 20}}>
                    ...
                    <Col xs={24} sm={12} md={8} lg={6} >
                        ...
                        <Select placeholder='Type' onChange={(val) => { props.genrateFilter('typeFilter', val, false) }} style={{ width:  '100%', marginBottom:10 }}>
                            {Type.map((val, i) => (
                                <Option value={val} key={val}>{val}</Option>
                            ))}
                    ...
                    <Col xs={24} sm={12} md={8} lg={6} >
                        ...
                        <Input placeholder='Style Code' onChange={(event) => { props.genrateFilter('stylecodeFilter', event.target.value, false) }} style={{ width:  '100%', height:42, marginBottom:10 }} placeholder="Style Code" />
                    ...
                    <Col xs={24} sm={12} md={8} lg={6} >
                        ...
                        <Select placeholder='Item Type' onChange={(val) => { props.genrateFilter('typeData', val, false) }} style={{ width:  '100%', marginBottom:10 }}>
                            {itemType.map((val, i) => (
                                <Option value={val} key={val}>{val}</Option>
                            ))}

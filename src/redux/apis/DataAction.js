...
export const chartSearsData = (data) => {
    return apiFetchDotNet('Orders/OrdersREPORTSears', "POST", headerDotNetWithJwt, JSON.stringify({ data }));
};
export const chartEbayData = (data) => {
    return apiFetchDotNet('Orders/OrdersREPORTEbay', "POST", headerDotNetWithJwt, JSON.stringify({ data }));
};
...
export const PUAppUpdateBanner = (data) => {
    return apiFetchDotNet('/Mobile/UpdateBanner', "POST", headerDotNetWithJwt, JSON.stringify(data));
};
